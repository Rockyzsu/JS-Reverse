...
const { JSDOM } = jsdom;
const dom = new JSDOM("", {
  url: "https://q.10jqka.com.cn/thshy/index/field/199112/order/desc/page/2/ajax/1/",
  referer: "https://q.10jqka.com.cn/thshy/index/field/199112/order/desc/page/2/ajax/1/",
...
var TOKEN_SERVER_TIME = 1743945706.22;
!(function (n, t) {
  !(function () {
    var r, e, a;
    r = e = a = n;
        ...
        return (
          (l[e[104]][w + m + I + u] = function () {
            for (var a = e[105], u = this[a + y], c = [], s = -e[0], v = o[2], f = u[r[56]]; v < f; v++)
              for (var l = this[v], p = u[v], d = (s += p); (c[d] = l & parseInt(t[77], n[78])), --p != r[52]; ) --d, (l >>= parseInt(n[79], i[106]));
            return c;
          }),
    ...
    !(function (n) {
      ...
      function O(n) {
        ...
        for (var c = ot(i[94]), l = e[2], p = n[o[56]], d = []; l < p; ) {
          var h =
            (I[n.charAt(l++)] << parseInt(at(t[117]), u[82])) | (I[n.charAt(l++)] << parseInt(v(t[118], u[95], e[119]), o[88])) | (I[n.charAt(l++)] << t[59]) | I[n.charAt(l++)];
          ...
          return function (t, a) {
            ...
            return (
              ...
              Qn[at(u[219], K)]
                ...
                : ((l = rt.update()), a[f[252]] ? (a[Bn + d][jn] = l) : ((a[h + r] = new Headers()), a[i[220]].append(jn, l))),
              n.call(this, t, a)
            );
          };
        });
